...
I needed all of the color palettes from [Google Docs](https://www.google.com/design/spec/style/color.html#color-color-palette) in XML.

I wrote a crappy [node script](index.js) to scrape the data.
